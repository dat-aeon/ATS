 ...
 *************************************************************************/
package mm.aeon.com.ats.front.operatorManagement;

import mm.aeon.com.ats.base.common.constants.ASSServiceStatusCommon;
import mm.aeon.com.ats.base.service.userInfoRegisterService.UserInfoRegisterServiceReqBean;
import mm.aeon.com.ats.base.service.userInfoRegisterService.UserInfoRegisterServiceResBean;
import mm.aeon.com.ats.base.service.userInfoUpdateService.UserInfoUpdateServiceReqBean;
import mm.aeon.com.ats.base.service.userInfoUpdateService.UserInfoUpdateServiceResBean;
...
public class OperatorManagementController extends AbstractController
    ...
    public OperatorManagementFormBean process(OperatorManagementFormBean formBean) {
        ...
        if (!formBean.getManagementHeaderBean().getForUpdate()) {
            ...
            registerReqBean.setUserTypeId(VCSCommon.USER_TYPE_ATS_OPERATOR_ID);
            ...
            updateReqBean.setUserTypeId(VCSCommon.USER_TYPE_ATS_OPERATOR_ID);
        ...
        if (ServiceStatusCode.RECORD_DUPLICATED_ERROR.equals(serviceStatus)) {
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Updating Operator Data already updated.", LogLevel.ERROR);
