...
public class AgentCallHistoryListLazySorter implements Comparator<MessagingHistoryListLineBean> {
    ...
    public AgentCallHistoryListLazySorter(String sortField, SortOrder sortOrder) {
