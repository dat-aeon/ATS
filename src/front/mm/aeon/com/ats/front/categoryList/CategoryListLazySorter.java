...
public class CategoryListLazySorter implements Comparator<CategoryListLineBean> {
    ...
    public CategoryListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(CategoryListLineBean member1, CategoryListLineBean member2) {
