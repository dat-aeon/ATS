...
public class AgentListLazySorter implements Comparator<AgentListLineBean> {
    ...
    public AgentListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(AgentListLineBean member1, AgentListLineBean member2) {
        applicationLogger.log("Agent List Sorter Process started.", LogLevel.INFO);
        try {
            ...
            applicationLogger.log("Agent List Sorter Process finished.", LogLevel.INFO);
