...
public class OperatorDeleteController extends AbstractController
    ...
    public OperatorListFormBean process(OperatorListFormBean formBean) {
        ...
        if (ServiceStatusCode.OK.equals(serviceStatus)) {
            ...
            applicationLogger.log("Operator Brand data already updated.", LogLevel.ERROR);
            ...
            applicationLogger.log(msgBean.getMessage(), LogLevel.ERROR);
            applicationLogger.log("Operator brand data already deleted by other.", LogLevel.ERROR);
