 ...
 *************************************************************************/
package mm.aeon.com.ats.front.adminManagement;
...
public class AdminManagementController extends AbstractController
    ...
    public AdminManagementFormBean process(AdminManagementFormBean formBean) {
        ...
        if (!formBean.getIsUpdate()) {
            ...
            serviceReqBean.setUserTypeId(VCSCommon.USER_TYPE_ATS_ADMIN_ID);
            ...
            updateServiceReqBean.setUserTypeId(VCSCommon.USER_TYPE_ATS_ADMIN_ID);
